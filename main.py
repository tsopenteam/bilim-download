...
/***************************************************************************
 *                                                                         *
 *   Bu program teknoseyir teknoloji ve bilim notları podcastlerini        *
...
try:
    ...
    # Define Veriable
    directory = "podcasts"
    download_url = "https://raw.githubusercontent.com/tsopenteam/bilim/master/bilim.json"
    podcast_list = []
    ...
    def download_all_podcast():
        ...
        for item in podcast_list:
            podcast_name = f'bilim-{str(item["totalCount"])}-{item["year"]}-{str(item["count"])}.mp3'
